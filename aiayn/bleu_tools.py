"""
This file is mostly verbatim copied code from the tensor2tensor repo here:
    https://github.com/tensorflow/tensor2tensor

The intentiion is to reproduce the results in the Attention is All You Need paper
with an implementation of the model from scratch, based on the description in the
paper.  But, in order to ensure the same Bleu evaluation, I decided to not
re-implement the Blue score computation.
...
def bleu_wrapper(ref_filename, hyp_filename, case_sensitive=False):
  ...
  ref_filename:  file containing one reference sentence per line
    format:  <id> TAB <source_sentence> TAB <target_sentence>
